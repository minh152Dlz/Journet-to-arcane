...
public class AtkWizard : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isAtOriginalPosition)
        {
            ...
            // L?a ch?n ng?u nhi?n k? n?ng t?n c?ng
            ...
            if (PlayerInSight())
            {
                if (cooldownTimer >= attackCooldown)
                {
                    ...
                    }else if(healthWizard.health <= 700)
                    {
                        numberOfBullets = 18;
                        angleBetweenBullets = 20f;
                        bulletSpeed = 12f;
                    }
                }
            }
    ...
    private void SpawnSouls()
    {
        ...
        GameObject soul1 = Instantiate(soul2Prefab, bossPosition + Vector3.left * 4f, Quaternion.identity);
        GameObject soul2 = Instantiate(soul2Prefab, bossPosition + Vector3.right * 4f, Quaternion.identity);
